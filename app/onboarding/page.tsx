  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pb-24">
        ...
        {/* Description */}
        <p className="text-center text-gray-600 max-w-2xl mb-8 leading-relaxed text-base">
        ...
        {currentStepData.isForm && currentStepData.formType === 'highschool' && (
          <div className="bg-white rounded-2xl p-6 border border-gray-200 mb-8 w-full max-w-md">
